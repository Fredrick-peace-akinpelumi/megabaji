    ...
    <>
      <nav className="navbar bg-body-tertiary fixed-top" style={{backgroundColor:"rgb(0,93,171)"}}>
        <div className="container">
          ...
          {/* IF USER IS LOGGED IN ,IT WILL SHOW THE FIRST DIV IF NOT, IT WILL SHOW THE DIV AFTER THE COLON */}
          {isLoggedIn?
            <div className="d-flex justify-space-between" >
              <Link to='/login'><button className="btn text-white" style={{backgroundColor:"rgb(35,134,228)"}} >Deposit</button></Link>
              <Link to='/signup'><button className="btn text-white ms-5"  style={{backgroundColor:"rgb(101,204,48)"}}>User</button></Link>
              <Link to='/login'><button className="btn text-white ms-5" style={{backgroundColor:"rgb(0,0,0)"}} >Log Out</button></Link>
            {/* <button></button> */}
            </div>
          :
            <div className="d-flex justify-space-between" >
